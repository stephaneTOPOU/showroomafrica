...
<meta property="og:url" content="https://www.showroomafrica.com/bf/pharmacie/2" />
<link rel="canonicail" href="https://www.showroomafrica.com/bf/pharmacie/2">
        ...
        <div class="professionals">
            @foreach ($pharmacies as $pharmacie)
                <div class="professional-info">
                    <div class="left">
                        <div class="header">
                            <h3 class="professional-name"><b><a href="{{ route('entreprise.bf.profil',['pays_id'=>$pharmacie->pays_id,'entreprise_id'=>$pharmacie->id]) }}">{{ $pharmacie->nom }}</a></b></h3>
                            <ul>
