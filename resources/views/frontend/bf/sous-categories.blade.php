...
<meta property="og:url" content="https://www.showroomafrica.com/bf/{{ $souscategorie->slug_categorie }}" />
<link rel="canonicail" href="https://www.showroomafrica.com/bf/{{ $souscategorie->slug_categorie }}">
@endforeach
