...
<div class="container">
    ...
    <div class="companies-container">
        ...
        <div class="search-bar" style="margin-bottom:2em;">
            <form action="{{ route('recherche.pays', ['slug_pays' => 'bf']) }}" autocomplete="off" class="search-form"
                method="GET">
        ...
        @foreach ($sousCategories as $sousCategorie)
            <div id="devismodal" class="devis-modal">
                ...
                <div class="contact devis-modal-content">
                    ...
                    @endif
                    <form
                        action="{{ route('devis.pays.entreprise', ['slug_pays' => 'bf', 'souscategorie_id' => $sousCategorie->identifiant]) }}"
                        method="POST">
                        @csrf
