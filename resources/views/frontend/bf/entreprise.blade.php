...
@foreach ($entreprises as $entreprise)
    ...
    <link rel="canonical" href="https://www.showroomafrica.com/tg/{{ $entreprise->slug_categorie }}/{{ $entreprise->slug_souscategorie }}" />
@endforeach
        ...
        @foreach ($sousCategories as $sousCategorie)
            <div id="devismodal" class="devis-modal">
                ...
                <div class="contact devis-modal-content">
                    ...
                    @endif
                    <form action="{{ route('devis.pays.entreprise',['slug_pays'=>'bf','souscategorie_id'=>$sousCategorie->identifiant]) }}" method="POST">
                        @csrf
