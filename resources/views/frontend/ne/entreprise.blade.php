...
@foreach ($entreprises as $entreprise)
    <meta property="og:url"
        content="https://www.showroomafrica.com/ne/{{ $entreprise->slug_categorie }}/{{ $entreprise->slug_souscategorie }}" />
    <link rel="canonical"
        href="https://www.showroomafrica.com/ne/{{ $entreprise->slug_categorie }}/{{ $entreprise->slug_souscategorie }}" />
@endforeach
...
<div class="container">
    ...
    <div class="companies-container">
        ...
        <div class="search-bar" style="margin-bottom:2em;">
            <form action="{{ route('recherche.pays', ['slug_pays' => 'ne']) }}" autocomplete="off" class="search-form"
                method="GET">
        ...
        @foreach ($sousCategories as $sousCategorie)
            <div id="devismodal" class="devis-modal">
                ...
                <div class="contact devis-modal-content">
                    ...
                    @endif
                    <form
                        action="{{ route('devis.pays.entreprise', ['slug_pays' => 'ne', 'souscategorie_id' => $sousCategorie->identifiant]) }}"
                        method="POST">
                        @csrf
