...
@foreach ($entreprises as $entreprise)
    <meta property="og:url" content="https://www.showroomafrica.com/ne/entreprise/11/{{ $entreprise->id }}"  />
    <link rel="canonicail" href="https://www.showroomafrica.com/ne/entreprise/11/{{ $entreprise->id }}" />
@endforeach
        ...
        @foreach ($sousCategories as $sousCategorie)
            <div id="devismodal" class="devis-modal">
                ...
                <div class="contact devis-modal-content">
                    ...
                    @endif
                    <form action="{{ route('devis.ne.entreprise',['pays_id'=>6,'souscategorie_id'=>$sousCategorie->identifiant]) }}" method="POST">
                        @csrf
                ...
                @foreach ($entreprises as $key => $entreprise)
                    ...
                    @else
                        <div class="company-info">
                            <div class="left">
                                <div class="header">
                                    <h3 class="company-name"><a href="{{ route('entreprise.ne.profil',['pays_id'=>$entreprise->pays_id,'entreprise_id'=>$entreprise->id]) }}">{{$entreprise->nom}}</a></h3>
