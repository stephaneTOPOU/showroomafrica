...
<meta property="og:url" content="https://www.showroomafrica.com/ne/liste-pharmacie-de-garde" />
<link rel="canonical" href="https://www.showroomafrica.com/ne/liste-pharmacie-de-garde" />
                    ...
                    <div class="left">
                        <div class="header">
                            ...
                            <ul>
                                ...
                                @if ($pharmacie->telephone1) <li><i class="fa-light fa-phone"></i>(+227) <b> {{ $pharmacie->telephone1 }} </b> @if ($pharmacie->telephone2)<b> • {{ $pharmacie->telephone2 }} </b> @endif </li>  @endif
