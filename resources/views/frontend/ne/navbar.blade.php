...
<nav>
    ...
    @foreach ($parametres as $parametre)
        <a href="{{ route('home.ne',['pays_id'=>11]) }}" class="nav-icon" aria-label="visit homepage" aria-current="page">
    ...
    <div class="main-navlinks">
        ...
        <div class="navlinks-container">
            <ul>
            <li>
                <a href="#" id="flag" aria-current="page" class="current"><span class="flag fi fi-ne"></span> Niger </a>
            </li>
            <li>
                <a href="{{ route('categorie.ne',['pays_id'=>11]) }}">Entreprises</a>
            </li>
            {{-- <li class="dropdown">
            ...
            <li>
                <a href="{{ route('professionnel.ne',['pays_id'=>11]) }}">Professionnels</a>
            </li>
            <li class="dropdown">
            ...
            <li class="dropdown">
                ...
                <a href="#">Audit</a><br>
                <a href="{{ route('service.ne.siteweb',['pays_id'=>11]) }}">Sites web</a><br>
                <a href="#">Centres d'appel</a><br>
                </div>
            </li>
            <li>
                <a href="{{ route('contact.ne',['pays_id'=>11]) }}">Contact</a>
            </li>
            </ul>
            ...
            <div class="nav-authentication" id="">
                <div class="account dropdown">
                    ...
                    <div class="dropdown-content">
                        ...
                        <form method="Get" action="{{ route('logout.ne',['pays_id'=>11]) }}">
                            @csrf
                            <a href="{{ route('logout.ne',['pays_id'=>11]) }}" type="submit"><i class="fa-regular fa-arrow-right-from-bracket"></i> Déconnexion</a><br>
                        </form>
        ...
        <div class="form-container overflow">
            <div class="forms">
                <div class="form login">
                    ...
                    @endif
                    <form action="{{ route('authenticate.ne',['pays_id'=>11]) }}" method="POST">
                        @csrf
                    ...
                    <div class="login-signup">
                        ...
                        <span class="text">ou
                            <b><a href="{{ route('entreprise.register.ne',['pays_id'=>11]) }}" class="text signup-link">Enregistrez votre entreprise</a></b>
                        </span>
                    </div>
                </div>
                ...
                <div class="form signup">
                    ...
                    @endif
                    <form action="{{ route('user.ne.add',['pays_id'=>11]) }}" method="POST">
                        @csrf
                        <div class="fields">
        ...
        <div class="popup-container">
            <div class="countries">
                ...
                <div class="countries_flag">
                    ...
                    {{-- <a href="{{ route('home.bi',['pays_id'=>21]) }}" class="country_flag"><span class="flag fi fi-bi"></span> Burundi</a> --}}<a href="{{ route('home.bi',['pays_id'=>21]) }}" class="country_flag"><span class="flag fi fi-bi"></span> Burundi</a>
                    ...
                    <a href="{{ route('home.ne',['pays_id'=>11]) }}" class="country_flag selected"><span class="flag fi fi-ne"></span> Niger</a>
