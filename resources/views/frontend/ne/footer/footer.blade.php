        ...
        <div class="row">
            @foreach ($parametres as $parametre)
                ...
                <div class="footer-col">
                    <h4>liens rapides</h4>
                    <ul>
                        <li><a href="{{ route('home.ne',['pays_id'=>11]) }}">accueil Côte d'ivoire</a></li>
                        <li><a href="{{ route('categorie.ne',['pays_id'=>11]) }}">catégories</a></li>
                        <li><a href="{{ route('professionnel.ne',['pays_id'=>11]) }}">professionnels</a></li>
