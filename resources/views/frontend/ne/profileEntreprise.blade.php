...
<link rel="canonical" href="https://www.showroomafrica.com/ne/{{ $Profil_entreprise->slug_categorie }}/{{ $Profil_entreprise->slug_souscategorie }}/{{ $Profil_entreprise->slug_entreprise }}" />
@endforeach
