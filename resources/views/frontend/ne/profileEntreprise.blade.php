...
@foreach ($Profil_entreprises as $Profil_entreprise)
  <meta property="og:url" content="https://www.showroomafrica.com/ne/entreprise-profil/11/{{ $Profil_entreprise->id }}" />
  <link rel="canonicail" href="https://www.showroomafrica.com/ne/entreprise-profil/11/{{ $Profil_entreprise->id }}">
@endforeach
    ...
    @endforeach
      ...
      @foreach ($Profil_entreprises as $Profil_entreprise)
              ...
              <div class="contacts">
                <ul>
                  ...
                  @if ($Profil_entreprise->telephone1)
                    <li><i class="fa-light fa-phone"></i> (+227) <b>{{ $Profil_entreprise->telephone1 }} </b> 
        ...
        <div class="contact-form">    
          ...
          @endif
          <form action="{{ route('entreprise.ne.form',['pays_id'=>$Profil_entreprise->pays_id,'entreprise_id'=>$Profil_entreprise->id]) }}" method="POST">
            @csrf
