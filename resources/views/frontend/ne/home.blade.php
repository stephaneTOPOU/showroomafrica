            ...
            <div class="slider">
                <div class="slides">
                    ...
                    <div class="slider-slide first">
                        <img src="{{ asset('assets/images/sliders/side/9.jpg') }}">
                    </div>
            ...
            <div class="slider">
                <div class="slides">
                    ...
                    <div class="slider-slide second">
                        <img src="{{ asset('assets/images/sliders/side/7.jpg') }}">
                    </div>
        ...
        <div class="tower-ctn">
            @foreach ($pharmacies as $pharmacie)
                <div class="drugstore">
                    ...
                    <li><i class="fa-solid fa-phone"></i> (+227) <b>{{ $pharmacie->telephone1 }}</b></li>
                    </ul>
                </div>
            @endforeach
        </div>
