...
<nav>
    ...
    @foreach ($parametres as $parametre)
        <a href="{{ route('home.pays',['slug_pays'=>'bj']) }}" class="nav-icon" aria-label="visit homepage" aria-current="page">
    ...
    <div class="main-navlinks">
        ...
        <div class="navlinks-container">
            ...
            <li>
                <a href="{{ route('categorie.pays',['slug_pays'=>'bj']) }}">Entreprises</a>
            </li>
            {{-- <li class="dropdown">
            ...
            <li>
                <a href="{{ route('professionnel.pays',['slug_pays'=>'bj']) }}">Professionnels</a>
            </li>
            <li class="dropdown">
            ...
            <li class="dropdown">
                ...
                <a href="#">Audit</a><br>
                <a href="{{ route('service.pays.siteweb',['slug_pays'=>'bj']) }}">Sites web</a><br>
                <a href="#">Centres d'appel</a><br>
                </div>
            </li>
            <li>
                <a href="{{ route('contact.pays',['slug_pays'=>'bj']) }}">Contact</a>
            </li>
            </ul>
            ...
            <div class="nav-authentication" id="">
                <div class="account dropdown">
                    ...
                    <div class="dropdown-content">
                        ...
                        <form method="GET" action="{{ route('logout.pays',['slug_pays'=>'bj']) }}">
                            @csrf
                            <a href="{{ route('logout.pays',['slug_pays'=>'bj']) }}" type="submit"><i class="fa-regular fa-arrow-right-from-bracket"></i> Déconnexion</a><br>
                        </form>
        ...
        <div class="form-container overflow">
            <div class="forms">
                <div class="form login">
                    ...
                    @endif
                    <form action="{{ route('authenticate.pays',['slug_pays'=>'bj']) }}" method="POST">
                        @csrf
                    ...
                    <div class="login-signup">
                        ...
                        <span class="text">ou
                            <b><a href="{{ route('entreprise.register.pays',['slug_pays'=>'bj']) }}" class="text signup-link">Enregistrez votre entreprise</a></b>
                        </span>
                    </div>
                </div>
                ...
                <div class="form signup">
                    ...
                    @endif
                    <form action="{{ route('user.pays.add',['slug_pays'=>'bj']) }}" method="POST">
                        @csrf
                        <div class="fields">
        ...
        <div class="popup-container">
            <div class="countries">
                ...
                <div class="countries_flag">
                    ...
                    <a href="{{ route('home.pays',['slug_pays'=>'bj']) }}" class="country_flag selected"><span class="flag fi fi-bj"></span> Bénin</a>
