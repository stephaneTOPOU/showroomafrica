...
@foreach ($Profil_entreprises as $Profil_entreprise)
  <meta property="og:url" content="https://www.showroomafrica.com/bj/entreprise-profil/1/{{ $Profil_entreprise->id }}" />
  <link rel="canonicail" href="https://www.showroomafrica.com/bj/entreprise-profil/1/{{ $Profil_entreprise->id }}">
@endforeach
