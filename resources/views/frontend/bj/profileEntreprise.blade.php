...
@foreach ($Profil_entreprises as $Profil_entreprise)
  <meta property="og:url" content="https://www.showroomafrica.com/bj/{{ $Profil_entreprise->slug_entreprise }}" />
  <link rel="canonicail" href="https://www.showroomafrica.com/bj/{{ $Profil_entreprise->slug_entreprise }}">
@endforeach
