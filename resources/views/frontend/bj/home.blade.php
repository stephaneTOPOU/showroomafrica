...
{{-- <link href="https://cdn.jsdelivr.bft/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet"> --}}
...
<div id="popup" class="modal">
    ...
    <div class="modal-content">
        ...
        <div class="popup-container">
            <img alt="" src="{{ asset('assets/images/popup') }}/{{ $popups->image }}" alt="PUB" id="image"> 
        </div>
    </div>
</div>
<!-- END POPUP -->
...
<div class="container">
    ...
    <div class="sb-container">
        ...
        <div class="search-bar">
            <form action="{{ route('recherche.bj',['pays_id'=>1]) }}" method="GET" class="search-form">
    ...
    <div class="img-slider first-slider">
        <div class="slide active" data-bs-interval="1">
            <img alt="" src="{{ asset('assets/images/sliders/main/4.jpg') }}" alt="">
        </div>
        @foreach ($slider1s as $slider1)
            <div class="slide" data-bs-interval="1">
                <img alt="" src="{{ asset('assets/images/sliders/main') }}/{{ $slider1->image }}" alt="">
            </div>
        @endforeach
    </div>
    <!-- END ADS BIG SLIDER -->
    ...
    <div class="section-one">
        <div class="categories">
            ...
            <div class="categories-block">
                <div class="category">
                    <a href="{{ route('subcat.bj',['pays_id'=>1,'categorie_id'=>95]) }}">
                        <i class="fa-duotone fa-user"></i>
                        <p>Administrations</p>
                    </a>
                </div>
                <div class="category">
                    <a href="{{ route('subcat.bj',['pays_id'=>1,'categorie_id'=>103]) }}">
                        <i class="fa-duotone fa-user-doctor"></i>
                        <p>Santé</p>
                    </a>
                </div>
                <div class="category">
                    <a href="{{ route('subcat.bj',['pays_id'=>1,'categorie_id'=>105]) }}">
                        <i class="fa-duotone fa-island-tropical"></i>
                        <p>Culture, Tourisme & Loisirs</p>
                    </a>
                </div>
                <div class="category">
                    <a href="{{ route('subcat.bj',['pays_id'=>1,'categorie_id'=>110]) }}">
                        <i class="fa-duotone fa-buildings"></i>
                        <p>Immobilier</p>
                    </a>
                </div>
                <div class="category">
                    <a href="{{ route('subcat.bj',['pays_id'=>1,'categorie_id'=>104]) }}">
                        <i class="fa-duotone fa-tower-broadcast"></i>
                        <p>Télécommunication</p>
                    </a>
                </div>
                <div class="category">
                    <a href="{{ route('subcat.bj',['pays_id'=>1,'categorie_id'=>102]) }}">
                        <i class="fa-duotone fa-school"></i>
                        <p>Formation, éducation</p>
                    </a>
                </div>
                <div class="category">
                    <a href="{{ route('subcat.bj',['pays_id'=>1,'categorie_id'=>97]) }}">
                        <i class="fa-duotone fa-scale-balanced"></i>
                        <p>Comptabilité, conseil & juridique</p>
                    </a>
                </div>
                <div class="category">
                    <a href="{{ route('subcat.bj',['pays_id'=>1,'categorie_id'=>100]) }}">
                        <i class="fa-duotone fa-shop"></i>
                        <p>Commerces</p>
                    </a>
                </div>
                <div class="category">
                    <a href="{{ route('subcat.bj',['pays_id'=>1,'categorie_id'=>112]) }}">
            ...
            <div class="category-link">
                <a href="{{ route('categorie.bj',['pays_id'=>1]) }}">
            ...
            <div class="slider">
                <div class="slides">
                    ...
                    <div class="slider-slide first">
                        <img alt="" src="{{ asset('assets/images/sliders/side/babenin2.jpg') }}" alt="">
                    </div>
                    @foreach ($sliderLaterals as $sliderLateral)
                        <div class="slider-slide">
                            <img alt="" src="{{ asset('assets/images/sliders/side') }}/{{ $sliderLateral->image }}">
                        </div>
                    @endforeach
            ...
            <div class="slider">
                <div class="slides">
                    ...
                    <div class="slider-slide second">
                        <img alt="" src="{{ asset('assets/images/sliders/side/nsiabenin.jpg') }}">
                    </div>
                    @foreach ($sliderLateralBas as $sliderLateralBa)
                        <div class="slider-slide">
                            <img alt="" src="{{ asset('assets/images/sliders/side') }}/{{ $sliderLateralBa->image }}">
                        </div>
                    @endforeach
                    <div class="navigation-auto">
                        <div class="auto-btn1"></div>
        ...
        <div class="carousel-container">
            <div class="carousel">
                @foreach ($rejoints as $rejoint)
                    @if ($rejoint->logo)
                        <img alt="" src="{{ asset('assets/images/companies/logos') }}/{{ $rejoint->logo }}" alt="{{ $rejoint->nom }}" />
                    @else
    ...
    <div class="img-slider">
        ...
        @foreach ($slider2s as $slider2)
            <div class="slide-two">
                <img alt="" src="{{ asset('assets/images/sliders/main') }}/{{ $slider2->image }}" alt="">
            </div>
        @endforeach
    </div>
            ...
            <div class="highlights">
                @foreach ($honeures as $honeure)
                    <div class="hightlighted-company">
                        <img alt="" src="{{ asset('assets/images/highlights') }}/{{ $honeure->photo4 }}" alt="{{ $honeure->nom }}">
    ...
    <div class="section-one">
        ...
        <div class="highlights">
            <div class="autoplay">
                @foreach ($honeures as $honeure)
                    <a href="{{ route('entreprise.bj.profil',['pays_id'=>$honeure->pays_id,'entreprise_id'=>$honeure->id]) }}">
                        <div class="img-div"><img alt="" src="{{ asset('assets/images/highlights') }}/{{ $honeure->photo4 }}"></div>
                    </a>
                @endforeach
            </div>
        </div>
    ...
    <div class="section-one">
        ...
        <div class="advertorials">
            <div class="advertorial">
                <img alt="" src="{{ asset('assets/images/advertorial/telephonie.jpg') }}">
            ...
            <div class="advertorial">
                <img alt="" src="{{ asset('assets/images/advertorial/commerce.jpg') }}">
                <div class="overlay"></div>
                <a href="#">
            ...
            <div class="advertorial">
                <img alt="" src="{{ asset('assets/images/advertorial/education.jpg') }}">
                <div class="overlay"></div>
                <a href="#">
            ...
            <div class="advertorial">
                <img alt="" src="{{ asset('assets/images/advertorial/medecine.jpg') }}">
                <div class="overlay"></div>
                <a href="#">
            ...
            <div class="advertorial">
                <img alt="" src="{{ asset('assets/images/advertorial/alimentation.jpg') }}">
                <div class="overlay"></div>
                <a href="#">
            ...
            <div class="advertorial">
                <img alt="" src="{{ asset('assets/images/advertorial/divers.jpg') }}">
                <div class="overlay"></div>
                <a href="#">
    ...
    <div class="section-one">
        ...
        <div class="tower-ctn">
            @foreach ($pharmacies as $pharmacie)
                <div class="drugstore">
                    <img alt="" src="{{ asset('assets/images/drugstores') }}/{{ $pharmacie->photo1 }}">
                    <h3>{{ $pharmacie->nom }}</h3>
                    <ul>
                    <li>
                    ...
                    <li><i class="fa-solid fa-phone"></i> (+229) <b>{{ $pharmacie->telephone1 }}</b></li>
                    </ul>
                </div>
            @endforeach
        </div>
        ...
        <div class="category-link" style="text-align: center">
            <a href="{{ route('pharmacie.bj',['pays_id'=>1]) }}">
                <i class="fa-regular fa-plus"></i>
    ...
    <div class="img-slider">
        ...
        <div class="slide-three">
            <img alt="" src="{{ asset('assets/images/sliders/main') }}/{{ $slider3->image }}" alt="">
        </div>
        @endforeach
    </div>
            ...
            <div class="magazine">
                <div class="magazine-details">
                    ...
                    <button type="button" class="discover-btn">
                        <a href="{{ route('entreprise.bj.profil',['pays_id'=>$magazine->pays_id,'entreprise_id'=>$magazine->id]) }}"><i class="fa-light fa-plus"></i> Découvrir</a>
                    </button>
