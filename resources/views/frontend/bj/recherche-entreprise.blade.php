...
<meta property="og:url" content="https://www.showroomafrica.com/bj/rechercher-entreprise/1" />
<link rel="canonicail" href="https://www.showroomafrica.com/bj/rechercher-entreprise/1">
    ...
    <div class="companies-container">
        ...
        <div id="devismodal" class="devis-modal">
            ...
            <div class="contact devis-modal-content">
                ...
                @endif
                <form action="{{ route('devis.bj.recherche',['pays_id'=>1]) }}" method="POST">
                    @csrf
                ...
                @foreach ($recherches as $key => $recherche)
                    ...
                    @else
                        <div class="company-info">
                            <div class="left">
                                <div class="header">
                                    <h3 class="company-name"><a href="{{ route('entreprise.bj.profil',['pays_id'=>$recherche->pays_id,'entreprise_id'=>$recherche->id]) }}">{{$recherche->nom}}</a></h3>
