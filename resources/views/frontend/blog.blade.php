...
<meta property="og:url" content="https://www.showroomafrica.com/blog" />
<link rel="canonicail" href="https://www.showroomafrica.com/blog">
                ...
                <div class="blog-one">
                    <div class="blogs">
                        @foreach ($blogs as $blog)
                            <a class="blog" href="{{ route('blog.detail',['slug_blog'=>$blog->slug_blog]) }}">
