...
<nav>
    ...
    <div class="main-navlinks">
        ...
        <div class="navlinks-container">
            <ul>
            <li>
                <a href="#" id="flag" aria-current="page" class="current"><span class="flag fi fi-bi"></span> Burundi </a>
            </li>
            <li>
        ...
        <div class="popup-container">
            <div class="countries">
                ...
                <div class="countries_flag">
                    ...
                    <a href="{{ route('home.bi',['pays_id'=>21]) }}" class="country_flag selected"><span class="flag fi fi-bi"></span> Burundi</a>
