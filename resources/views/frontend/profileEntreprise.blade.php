...
@foreach ($Profil_entreprises as $Profil_entreprise)
    <meta property="og:url"
        content="https://www.showroomafrica.com/annuaire/{{ $Profil_entreprise->slug_categorie }}/{{ $Profil_entreprise->slug_souscategorie }}/{{ $Profil_entreprise->slug_entreprise }}" />
    <link rel="canonical"
        href="https://www.showroomafrica.com/annuaire/{{ $Profil_entreprise->slug_categorie }}/{{ $Profil_entreprise->slug_souscategorie }}/{{ $Profil_entreprise->slug_entreprise }}" />
@endforeach
    ...
    <div class="companies-container">
        ...
        @foreach ($Profil_entreprises as $Profil_entreprise)
                            ...
                            <ul>
                                ...
                                @if ($Profil_entreprise->telephone1)
                                    <li><i class="fa-light fa-phone"></i>
                                        @if ($Profil_entreprise->slug_pays == 'tg')
                                            (+228)
            ...
            <div class="contact-form">
                ...
                @endif
                <form
                    action="{{ route('entreprise.form', ['slug_categorie' => $Profil_entreprise->slug_categorie, 'slug_souscategorie' => $Profil_entreprise->slug_souscategorie, 'slug_entreprise' => $Profil_entreprise->slug_entreprise]) }}"
                    method="POST">
                    @csrf
