    ...
    <div class="companies-container">
      <div class="img-slider company-slider">
        <div class="slide active">
          <img src="assets/images/sliders/main/4.jpg" alt="">
        </div>
        <div class="slide">
          <img src="assets/images/sliders/main/4.jpg" alt="">
        </div>
      ...
      <div class="company-info company-banner">
        <div class="left">
          <div class="header">
            <h1 class="company-name">Showroom Africa</h1>
            ...
            <div class="page-views">
              ...
              <div class="product-rating">
                  ...
                  <i class="fa-solid fa-star"></i>
                  <i class="fa-solid fa-star"></i>
                  <a href="#" class="count-review">0.0 note(s)</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="right">
          <img src="assets/images/companies/logos/showroomafrica.png" alt="Showroom Africa">
        </div>
      </div>
      ...
      <div class="contact-form">
        <div class="contact-form-header">Ecrire à l'entreprise</div>
        <form action="#">
          <div class="input-box">
