...
@foreach ($Profil_entreprises as $Profil_entreprise)
    ...
    <link rel="canonicail" href="https://www.showroomafrica.com/annuaire/{{ $Profil_entreprise->slug_categorie }}/{{ $Profil_entreprise->slug_souscategorie }}/{{ $Profil_entreprise->slug_entreprise }}">
@endforeach
                    ...
                    <div class="slide-container">
                      <div class="card-wrapper swiper-wrapper">
                        @foreach ($partenaires as $partenaire)
                          <div class="card swiper-slide">
                            <div class="image-box">
                              <img src="{{ asset('assets/images/partenaires') }}/{{ $partenaire->image }}" alt="{{ $partenaire->image }}"/>
                            </div>
                            {{-- <div class="product-details">
