...
@foreach ($souscategories as $souscategorie)
    <meta property="og:url" content="https://www.showroomafrica.com/ci/sous-categories/6/{{ $souscategorie->identifiant }}" />
    <link rel="canonicail" href="https://www.showroomafrica.com/ci/sous-categories/6/{{ $souscategorie->identifiant }}">
@endforeach
