...
@foreach ($Profil_entreprises as $Profil_entreprise)
    <meta property="og:url"
        content="https://www.showroomafrica.com/ci/{{ $Profil_entreprise->slug_categorie }}/{{ $Profil_entreprise->slug_souscategorie }}/{{ $Profil_entreprise->slug_entreprise }}" />
    <link rel="canonical"
        href="https://www.showroomafrica.com/ci/{{ $Profil_entreprise->slug_categorie }}/{{ $Profil_entreprise->slug_souscategorie }}/{{ $Profil_entreprise->slug_entreprise }}" />
@endforeach
    ...
    <div class="companies-container">
        @foreach ($Profil_entreprises as $Profil_entreprise)
            <div class="img-slider company-slider">
                ...
                @if ($Profil_entreprise->photo2)
                    <div class="slide">
                        <img src="{{ asset('assets/images/sliders/couverture') }}/{{ $Profil_entreprise->photo2 }}"
        ...
        @foreach ($Profil_entreprises as $Profil_entreprise)
            ...
            <div class="companies-list">
                <div class="companies">
                        ...
                        <div class="contacts">
                            <ul>
                                ...
                                @if ($Profil_entreprise->telephone1)
                                    <li><i class="fa-light fa-phone"></i> (+225)
                                        <b>{{ $Profil_entreprise->telephone1 }} </b>
                                ...
                                @if ($Profil_entreprise->itineraire)
                                    <li><a href="{{ $Profil_entreprise->itineraire }}" class="website-link"><i
                                                class="fa-light fa-map-location-dot"></i>Itineraire</a></li>
                                @endif

                                @if ($Profil_entreprise->siteweb)
                                    <li><a href="{{ $Profil_entreprise->siteweb }}" class="website-link"
                                            target="_blank"><i
                                                class="fa-light fa-globe"></i>{{ $Profil_entreprise->siteweb }}</a>
                                    </li>
                                @endif
                    ...
                    @if ($Profil_entreprise->premium == 1 || $Profil_entreprise->basic == 1)
                        {{--                          Géolocalisation                                                     --}}
                        <div class="company-info">
                            <div class="contact-form-header">Retrouvez {{ $Profil_entreprise->nom }} sur la carte
                            </div>
                            <div class="company-map">
                                @if ($Profil_entreprise->geolocalisation)
                                    <iframe src="{{ $Profil_entreprise->geolocalisation }}" height="360"
                                        style="border:0;" allowfullscreen="true" loading="lazy"
                                        referrerpolicy="no-referrer-when-downgrade">
                                    </iframe>
                                @else
                                    <iframe
                                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d126771.81907477452!2d-5.281135900000001!3d6.81606695!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xfb8913a41c945f7%3A0x21701f1a1623eede!2sYamoussoukro%2C%20C%C3%B4te%20d&#39;Ivoire!5e0!3m2!1sfr!2stg!4v1709822160404!5m2!1sfr!2stg" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"
                            ...
                            <div class="flex-boxes">
                                <div id="jLightroom" class="jlr">
                                    @foreach ($galleries as $gallerie)
                                        <a href="{{ asset('assets/images/companies/showroom/gallery') }}/{{ $gallerie->galerie_image }}"
                                            data-lightbox="lb1" class="jlr_item"><img
                                                src="{{ asset('assets/images/companies/showroom/gallery') }}/{{ $gallerie->galerie_image }}"
                                                class="jlr_img" alt="{{ $gallerie->entreprise }}"></a>
                                    @endforeach
                                    @foreach ($galleries as $gallerie)
                                        <a href="{{ asset('assets/images/companies/showroom/gallery') }}/{{ $gallerie->galerie_image }}"
                                            data-lightbox="lb1" class="jlr_item"><img
                        ...
                        @if ($Profil_entreprise->premium == 1)
                            <div class="company-info">
                                <div class="contact-form-header">Présentation de {{ $Profil_entreprise->nom }}
                                </div>
                                @foreach ($services as $service)
                                    <div class="company-presentation">
                                        <div class="presentation-section">
                                            ...
                                            @if ($service->video)
                                                <br />
                                                <video src="{{ asset('assets/videos') }}/{{ $service->video }}"
                                                    autoplay muted controls width="100%"
                                                    style="border-radius: 1em"></video>
                                            @endif
                                        ...
                                        <div class="presentation-section">
                                            ...
                                            @if ($service->image2)
                                                <img src="{{ asset('assets/images/advertorial') }}/{{ $service->image2 }}"
                                        ...
                                        <div class="presentation-section">
                                            ...
                                            @endif
                                            @if ($service->image3)
                                                <img src="{{ asset('assets/images/advertorial') }}/{{ $service->image3 }}"
                                                    alt="{{ $service->entreprise }}">
                                            @endif
                                            <p>
                                                {!! $service->image5 !!}
                    ...
                    <div class="contact-form review">
                        ...
                        @endif
                        <form
                            action="{{ route('entreprise.commentaire', ['slug_souscategorie' => $Profil_entreprise->slug_souscategorie, 'slug_entreprise' => $Profil_entreprise->slug_entreprise]) }}"
                            method="POST">
                            @csrf
                            <div class="feedback">
                                <div class="rating">
            ...
            <div class="contact-form">
                ...
                @endif
                <form
                    action="{{ route('entreprise.pays.form', ['slug_pays' => $Profil_entreprise->slug_pays, 'slug_categorie' => $Profil_entreprise->slug_categorie, 'slug_souscategorie' => $Profil_entreprise->slug_souscategorie, 'slug_entreprise' => $Profil_entreprise->slug_entreprise]) }}"
                    method="POST">
                    @csrf
                    <div class="input-box" hidden>
                        <input type="text" placeholder="{{ $Profil_entreprise->nom }}" required
                            value="{{ $Profil_entreprise->nom }}" name="entrprise_nom">
                    </div>
                    <div class="input-box" hidden>
                        @if ($Profil_entreprise->email)
                            <input type="text" placeholder="{{ $Profil_entreprise->email }}" required
                                value="{{ $Profil_entreprise->email }}" name="entrprise_email">
                        @else
                            <input type="text" placeholder="contact@showroomafrica.com" required
                                value="contact@showroomafrica.com" name="entrprise_email">
                        @endif
                    </div>
                    <div class="input-box">
