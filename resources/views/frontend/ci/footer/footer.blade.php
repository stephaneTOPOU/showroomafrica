            ...
            <div class="row">
                @foreach ($parametres as $parametre)
                    ...
                    <div class="footer-col">
                        <h4>liens rapides</h4>
                        <ul>
                            <li><a href="{{ route('home.ci',['pays_id'=>6]) }}">accueil Côte d'ivoire</a></li>
                            <li><a href="{{ route('categorie.ci',['pays_id'=>6]) }}">catégories</a></li>
                            <li><a href="{{ route('professionnel.ci',['pays_id'=>6]) }}">professionnels</a></li>
