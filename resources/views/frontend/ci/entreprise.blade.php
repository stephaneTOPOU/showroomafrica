...
<link rel="canonicail" href="https://www.showroomafrica.com/ci/{{ $entreprise->slug_categorie }}/{{ $entreprise->slug_souscategorie }}" />
@endforeach
                                ...
                                <div class="contacts">
                                    <ul>
                                        ...
                                        @if ($entreprise->telephone1)
                                            <li><i class="fa-light fa-phone"></i> (+225) <b>{{ $entreprise->telephone1 }} </b>
