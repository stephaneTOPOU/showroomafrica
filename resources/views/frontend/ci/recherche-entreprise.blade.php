...
<meta property="og:url" content="https://www.showroomafrica.com/ci/rechercher-entreprise/6" />
<link rel="canonicail" href="https://www.showroomafrica.com/ci/rechercher-entreprise/6">
    ...
    <div class="companies-container">
        ...
        <div id="devismodal" class="devis-modal">
            ...
            <div class="contact devis-modal-content">
                ...
                @endif
                <form action="{{ route('devis.ci.recherche',['pays_id'=>6]) }}" method="POST">
                    @csrf
