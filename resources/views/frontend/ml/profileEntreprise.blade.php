...
@foreach ($Profil_entreprises as $Profil_entreprise)
    <meta property="og:url"
        content="https://www.showroomafrica.com/ml/{{ $Profil_entreprise->slug_categorie }}/{{ $Profil_entreprise->slug_souscategorie }}/{{ $Profil_entreprise->slug_entreprise }}" />
    <link rel="canonical"
        href="https://www.showroomafrica.com/ml/{{ $Profil_entreprise->slug_categorie }}/{{ $Profil_entreprise->slug_souscategorie }}/{{ $Profil_entreprise->slug_entreprise }}" />
@endforeach
                        ...
                        <div class="contacts">
                            <ul>
                                ...
                                @if ($Profil_entreprise->telephone1)
                                    <li><i class="fa-light fa-phone"></i> (+223)
                                ...
                                @if ($Profil_entreprise->itineraire)
                                    <li><a href="{{ $Profil_entreprise->itineraire }}"><i
                    ...
                    @if ($Profil_entreprise->premium == 1 || $Profil_entreprise->basic == 1)
                        ...
                        <div class="company-info">
                            ...
                            <div class="company-map">
                                ...
                                @else
                                    <iframe
                                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d124593.25491042466!2d-7.9955130500000005!3d12.61259115!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xe51cd1227450a91%3A0x9e3c40e152506015!2sBamako%2C%20Mali!5e0!3m2!1sfr!2stg!4v1709823689044!5m2!1sfr!2stg" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"
