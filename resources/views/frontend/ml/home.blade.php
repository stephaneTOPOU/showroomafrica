...
<div class="container">
        ...
        <div class="sb-container">
            <div class="search-text">
                <h1>
                    ...
                    Annuaire des professionnels au Burkina Faso
                </h1>
            </div>
            ...
            <div class="search-bar">
                <form action="{{ route('recherche.pays',['slug_pays'=>'ml']) }}" method="GET" class="search-form">
                    ...
                    <script type="text/javascript">
                        var path = "{{ route('autocomplete.pays',['slug_pays'=>'ml']) }}" ;
    ...
    <div class="section-one">
        <div class="categories">
            ...
            <div class="categories-block">
                <div class="category">
                    <a href="{{ route('subcat.pays',['slug_pays'=>'ml','slug_categorie'=>'gouvernement-et-ambassades']) }}">
                        <i class="fa-duotone fa-user"></i>
                        <p>Gouvernement et Ambassades</p>
                    </a>
                </div>
                <div class="category">
                    <a href="{{ route('subcat.pays',['slug_pays'=>'ml','slug_categorie'=>'sante-4']) }}">
                        <i class="fa-duotone fa-user-doctor"></i>
                        <p>Santé</p>
                    </a>
                </div>
                <div class="category">
                    <a href="{{ route('subcat.pays',['slug_pays'=>'ml','slug_categorie'=>'tourisme-et-culture']) }}">
                        <i class="fa-duotone fa-island-tropical"></i>
                        <p>Tourisme et Culture</p>
                    </a>
                </div>
                <div class="category">
                    <a href="{{ route('subcat',['slug_categorie'=>'communication-publicite-et-medias']) }}">
                        <i class="fa-duotone fa-bullhorn"></i>
                        <p>Communication, Publicité et Médias</p>
                    </a>
                </div>
                <div class="category">
                    <a href="{{ route('subcat.pays',['slug_pays'=>'ml','slug_categorie'=>'telecommunications-et-electroniques']) }}">
                        <i class="fa-duotone fa-tower-broadcast"></i>
                        <p>Télécommunications et Électroniques</p>
                    </a>
                </div>
                <div class="category">
                    <a href="{{ route('subcat',['slug_categorie'=>'conseil-et-services-aux-entreprises']) }}">
                        <i class="fa-duotone fa-scale-balanced"></i>
                        <p>Conseil et Services aux Entreprises</p>
                    </a>
                </div>
                <div class="category">
                    <a href="{{ route('subcat',['slug_categorie'=>'vehicules-pieces-et-materiaux-de-transport']) }}">
                        <i class="fa-duotone fa-car"></i>
                        <p>Véhicules, Piéces et Matériaux de Transport</p>
                    </a>
                </div>
                <div class="category">
                    <a href="{{ route('subcat.pays',['slug_pays'=>'ml','slug_categorie'=>'ongs-et-organismes']) }}">
                        <i class="fa-duotone fa-shop"></i>
                        <p>ONGs et Organismes</p>
                    </a>
                </div>
                <div class="category">
                    <a href="{{ route('subcat.pays',['slug_pays'=>'ml','slug_categorie'=>'banque-et-finance']) }}">
            ...
            <div class="category-link">
                <a href="{{ route('categorie.pays',['slug_pays'=>'ml']) }}">
            ...
            <div class="slider">
                <div class="slides">
                    ...
                    <div class="slider-slide first">
                        <img src="{{ asset('assets/images/sliders/side/bms_mali.jpg') }}" alt="bms_mali">
                    </div>
            ...
            <div class="slider">
                <div class="slides">
                    ...
                    <div class="slider-slide second">
                        <img src="{{ asset('assets/images/sliders/side/orange.jpg') }}" alt="orange">
                    </div>
    ...
    <div class="section-one">
        ...
        <div class="tower-ctn">
            @foreach ($pharmacies as $pharmacie)
                <div class="drugstore">
                    ...
                    <li><i class="fa-solid fa-phone"></i> (+223) <b>{{ $pharmacie->telephone1 }}</b></li>
                    </ul>
                </div>
            @endforeach
        </div>
        ...
        <div class="category-link" style="text-align: center">
            <a href="{{ route('pharmacie.pays',['slug_pays'=>'ml']) }}">
                <i class="fa-regular fa-plus"></i>
