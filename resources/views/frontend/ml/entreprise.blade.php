...
@foreach ($entreprises as $entreprise)
    <meta property="og:url" content="https://www.showroomafrica.com/ml/{{ $entreprise->slug_categorie }}/{{ $entreprise->slug_souscategorie }}"  />
    <link rel="canonical" href="https://www.showroomafrica.com/ml/{{ $entreprise->slug_categorie }}/{{ $entreprise->slug_souscategorie }}" />
@endforeach
...
<div class="container">
    ...
    <div class="companies-container">
        ...
        <div class="search-bar" style="margin-bottom:2em;">
            <form action="{{ route('recherche.pays',['slug_pays'=>'ml']) }}" autocomplete="off" class="search-form" method="GET">
        ...
        @foreach ($sousCategories as $sousCategorie)
            <div id="devismodal" class="devis-modal">
                ...
                <div class="contact devis-modal-content">
                    ...
                    @endif
                    <form action="{{ route('devis.pays.entreprise',['slug_pays'=>'ml','souscategorie_id'=>$sousCategorie->identifiant]) }}" method="POST">
                        @csrf
                                ...
                                <div class="contacts">
                                    <ul>
                                        ...
                                        @if ($entreprise->telephone1)
                                            <li><i class="fa-light fa-phone"></i> (+223) <b>{{ $entreprise->telephone1 }} </b>
