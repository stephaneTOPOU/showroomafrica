@include('frontend.ml.header.header')
    <meta property="og:url" content="https://www.showroomafrica.com/ml/rechercher-entreprise" />
    <link rel="canonical" href="https://www.showroomafrica.com/ml/rechercher-entreprise" />
    ...
    <div class="companies-container">
        ...
        <div id="devismodal" class="devis-modal">
            ...
            <div class="contact devis-modal-content">
                ...
                @endif
                <form action="{{ route('devis.pays.recherche',['slug_pays'=>'ml']) }}" method="POST">
                    @csrf
                                ...
                                <div class="contacts">
                                    <ul>
                                        ...
                                        @if ($recherche->telephone1)
                                            <li><i class="fa-light fa-phone"></i> (+223) <b>{{ $recherche->telephone1 }}</b>
                    ...
                    @foreach ($entreprisePopulaire as $entreprisePopulair)
                        <div class="top-company-info card" style="--delay:2;">
                            ...
                            <ul>
                                ...
                                <li><i class="fa-solid fa-phone"></i> (+223) <b>{{ $entreprisePopulair->telephone1 }}</b></li>
                            </ul>
                        </div>
                    @endforeach
                </div>
