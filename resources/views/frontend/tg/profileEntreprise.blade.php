...
@foreach ($Profil_entreprises as $Profil_entreprise)
    <meta property="og:url"
        content="https://www.showroomafrica.com/tg/{{ $Profil_entreprise->slug_categorie }}/{{ $Profil_entreprise->slug_souscategorie }}/{{ $Profil_entreprise->slug_entreprise }}" />
    <link rel="canonical"
        href="https://www.showroomafrica.com/tg/{{ $Profil_entreprise->slug_categorie }}/{{ $Profil_entreprise->slug_souscategorie }}/{{ $Profil_entreprise->slug_entreprise }}" />
@endforeach
                        ...
                        <div class="contacts">
                            <ul>
                                ...
                                @if ($Profil_entreprise->telephone1)
                                    <li><i class="fa-light fa-phone"></i> (+228)
