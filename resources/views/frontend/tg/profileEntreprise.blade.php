...
@foreach ($Profil_entreprises as $Profil_entreprise)
  ...
  <link rel="canonical" href="https://www.showroomafrica.com/tg/{{ $Profil_entreprise->slug_categorie }}/{{ $Profil_entreprise->slug_souscategorie }}/{{ $Profil_entreprise->slug_entreprise }}" />
@endforeach
