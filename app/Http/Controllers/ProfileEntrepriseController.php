...
//****************************************************Profile des entreprise Bénin************************************************* */
public function ProfileEntreprise_bj($pays_id, $entreprise_id)
{
    $parametres = DB::table('pays')->where('pays.id', $pays_id)
        ->join('parametres', 'pays.id', '=', 'parametres.pays_id')
    ...
    return view('frontend.bj.profileEntreprise', compact('sousCategorieNavs', 'parametres', 'Profil_entreprises',
'avis3', 'avis', 'services', 'serviceImages', 'horaires', 'galleries', 'premiums', 'basics', 'partenaires'));
}

//****************************************************End Profile des entreprise Bénin************************************************* */
}
